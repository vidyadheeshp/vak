...
मुद्रय छानय(करणम्: समः, अपादानम्: अङ्काः)।''',
    ...
    "अनुक्तम् कारकम्": '''# अनुक्तम् कारकम् — संस्कृतम् सर्वाणि कारकाणि न अपेक्षते।
# "देवदत्तः पचति" इति पूर्णम् वाक्यम्, न तत्र कर्म न करणम् उक्तम्।
# मूलमूल्ययुक्तः प्राचलः तादृशः एव: कारकम् अस्ति, अत्र न उक्तम्।
#
# An unexpressed kāraka is ordinary Sanskrit.  Because the roles are
# named rather than counted, the default may sit anywhere in the list —
# here the करणम् stands between two required roles, which a language
# with positional arguments could not allow.
...
# मूलमूल्यम् साक्षात् एव भवति — अङ्कः, शब्दः, सत्य, असत्य, शून्य इति।
# अतः आह्वानकाले किमपि न गण्यते, न च आह्वानयोः मध्ये किमपि साधारणम्।
कार्यम् अभिवादय(शब्दः नाम, शब्दः वचनम् = "नमस्ते") : शब्दः {
    प्रत्यागच्छ वचनम् + ", " + नाम + "।"।
}

मुद्रय अभिवादय("रामः")।
मुद्रय अभिवादय("रामः", "स्वागतम्")।''',

    "लक्षणम् प्रयुज् च": '''# लक्षणम् — यत् कार्यम् आत्मनः विषये घोषयति।
# प्रयुज् — तेन ज्ञातेन आह्वानम् रचयति।
#
# लक्षणम् reads a function's parameters — names, types, kāraka roles, and
# whether each may go unstated. प्रयुज् then applies the function to
# arguments that were computed rather than written out: a सूची fills the
# parameters in order, a कोशः fills them by role name.
कार्यम् लिखतु(कर्ता शब्दः लेखकः,
              करणम् शब्दः साधनम् = "लेखन्या",
              कर्म शब्दः ग्रन्थः) : शब्दः {
    प्रत्यागच्छ लेखकः + " '" + ग्रन्थः + "' " + साधनम् + " लिखति"।
...
# कारकनाम्ना — करणम् अनुक्तम्, यतः तस्य मूलमूल्यम् अस्ति।
मुद्रय प्रयुज्(लिखतु, {"कर्ता": "कालिदासः", "कर्म": "मेघदूतम्"})।
मुद्रय प्रयुज्(लिखतु, {"karta": "भवभूतिः", "karma": "उत्तररामचरितम्",
                       "karanam": "तूलिकया"})।

# स्थानेन — सूची क्रमेण पूरयति।
कार्यम् योगः(अ, ब, स) { प्रत्यागच्छ अ + ब + स। }
मुद्रय प्रयुज्(योगः, [१, २, ३])।

# यत् पूर्वम् अशक्यम् आसीत् — आवरणम् यत् प्राचलान् अग्रे नयति।
कार्यम् गणयित्वा(कार्यम् क, सूची अर्घाः) {
    मुद्रय "आह्वानम् प्राचलैः:", दीर्घता(अर्घाः)।
    प्रत्यागच्छ प्रयुज्(क, अर्घाः)।
}
मुद्रय गणयित्वा(योगः, [१०, २०, ३०])।''',
